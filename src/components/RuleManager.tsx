...
export function RuleManager({ settings, categories, accounts, onSaveSettings }: {
  ...
  return <Card className="p-4 sm:p-5">
    ...
    <div className="mt-5 border-t border-stone-100 pt-4 dark:border-stone-800"><div className="mb-3 text-sm font-semibold text-stone-800 dark:text-stone-200">{t('rules.create')}</div><div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
