...
export function Shell() {
  const { googleSession, googleRememberedUser, googleConnectionState, syncBusy, syncMessage, syncProgress, syncNow, retryGoogleConnection, lock } = useWallet()
  const { t } = useI18n()
