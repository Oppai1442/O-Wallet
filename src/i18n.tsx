...
const vi: Record<string, string> = {
  ...
  'settings.subtitle': 'Không có backend dữ liệu riêng. Trạng thái đăng nhập và mở khóa có thể được ghi nhớ cục bộ theo lựa chọn trên từng thiết bị.',
...
const en: Record<string, string> = {
  ...
  'settings.subtitle': 'There is no O-Wallet data backend. Sign-in and vault unlock state can be remembered locally per device.',
